...
// class MyPortfoliaPage extends StatefulWidget {
//   const MyPortfoliaPage({super.key});

//   @override
//   State<MyPortfoliaPage> createState() => _MyPortfoliaPageState();
// }
// bool show =false;
// class _MyPortfoliaPageState extends State<MyPortfoliaPage> {
...
//   List<Color> Pincklist3=[Color.fromARGB(255, 193, 193, 193),Colors.white60];
...
//   List<Color> Dugoutlist3=[Color.fromARGB(255, 193, 193, 193),Colors.white60];
...
//   List<Color> Notechatlist3=[Color.fromARGB(255, 193, 193, 193),Colors.white60];

//   List<String> movielist=["Movie Recommendations","search"];
//   List<String> movielist2=["assets/movie.png","assets/movie2.png"];
//   List<Color> movielist3=[Color.fromARGB(255, 193, 193, 193),Colors.white60];
...
//   List<Color> travellist3=[Color.fromARGB(255, 193, 193, 193),Colors.white60];
...
//   List<Color> Cataloglistt3=[Color.fromARGB(255, 193, 193, 193),Colors.white60];
...
// //  there are 3 types of gridviews, count , builder and extend builder

// // Widget _griviewlearn(){
// //   return Container(
// //     child: Column(
// //       children: [
// //         //  COUNT
// //         Container(
// //           height: 200,
// //           child: GridView.count(crossAxisCount: 3, // divides the space in 3 parts
// //           mainAxisSpacing: 15,
// //           crossAxisSpacing: 11,
// //           children: [
...
// //         Container(
// //           height: 200,
// //           child: GridView.extent(maxCrossAxisExtent: 100,  // makes each cell of a max value 100
// //           children: [Container(color: Colors.black26,)],),
// //         ),
      
// //         SizedBox(height: 200,),
// //         // BUILDER
// //         Container(height: 200,child: 
// //         GridView.builder(gridDelegate:SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 3) // this is required
